const tempDiscountData = [
  ...
  },
  {
    ...
    message: "Free shipping unlocked.<br> Add 1 more pack and save 20%.",
  },
  {
    count: 3,
    reward: "20% off",
    message:
      "Free shipping and 20% unlocked. Add one more pack to reveal our limited edition free gift.",
  },
  {
    count: 4,
    reward: null,
    message:
      "Add another pack to receive our limited edition trucker hat and fanny pack.",
  },
  {
    count: 5,
    reward: null,
    message:
      "Winner, winner – your order will ship for free, with 20% off plus two free limited edition gifts.",
  },
];
